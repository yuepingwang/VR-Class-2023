...
export const init = async model => {
    ...
    box.add('cube').color(.87,.68,.5).texture('../media/textures/box-front.png');//front side
    box.add('cube').color(.87,.68,.5).texture('../media/textures/box-side.png');// left side
    ...
    let leg1 = model.add();
    leg1.add('tubeY').color(0.55,.4,.2).texture('../media/textures/tree2.jpeg');
    leg1.add('tubeY').color(0.55,.4,.2).texture('../media/textures/tree2.jpeg');
    leg1.add('sphere').color(0.55,.4,.2).texture('../media/textures/tree2.jpeg');
    leg1.add(shoe1);

    let leg2 = model.add();
    leg2.add('tubeY').color(.55,.4,.2).texture('../media/textures/tree2.jpeg');
    leg2.add('tubeY').color(.55,.4,.2).texture('../media/textures/tree2.jpeg');
    leg2.add('sphere').color(.55,.4,.2).texture('../media/textures/tree2.jpeg');
    leg2.add(shoe2);
    ...
    model.move(0,1.5,0).scale(.3).animate(() => {
        ...
        box.child(7).identity().move(-.1,-.16,.54).turnZ(.3).turnX(-0.6).scale(.08,.06,.06);
        box.child(8).identity().move(.1,-.16,.54).turnZ(-.3).turnX(-0.6).scale(.08,.06,.06);
